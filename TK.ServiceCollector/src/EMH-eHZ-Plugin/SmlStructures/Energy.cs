namespace EMH_eHZ_Plugin.SmlStructures
{
    ...
    public sealed class Energy
    {
        ...
        public static double Parse(byte[] smlData, ref int currentPosition, byte[] firstSequence)
        {
            if (ArrayHelpers.CheckSequence(smlData, ref currentPosition, firstSequence)) {
            ...
            throw new Exception("cannot parse Energy structure: Positon:" + currentPosition.ToString());
        }
    }
}
